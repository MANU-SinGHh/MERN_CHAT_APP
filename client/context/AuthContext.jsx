...
export const AuthProvider=({children})=>{
    ...
    const checkAuth=async()=>{
        ...
        // this function will also handle signup depend on ${state} given
    ...
    useEffect(() => {
    // Set the default token header for all Axios requests
    if (token) {
        axios.defaults.headers.common['token'] = token;
        // After setting the token, check if the user is authenticated.
        checkAuth();
    }
}, [token]);
