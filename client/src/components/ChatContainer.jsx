...
function ChatContainer() {
  ...
  <div className='absolue bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
    <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
      ...
      {/* below imput and label tag input tag accepts the png and jpg images which can be uploaded and this prop is hidden
          and accepts html for image which we clcik on img icon we get option to upload our image */}
